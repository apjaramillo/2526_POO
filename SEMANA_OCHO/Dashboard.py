...
def mostrar_menu():
    ...
    '1': 'SEMANA_DOS/abstraccion.py',
    '2': 'SEMANA_TRES/programacion_tradicional.py',
    '3': 'SEMANA_CUATRO/poo_real.py',
    '4': 'SEMANA_CINCO/figura.py',
    '5': 'SEMANA_SEIS/tarea.py',
    '6': 'SEMANA_SIETE/destructor.py',
    '7': 'SEMANA_OCHO/Dashboard.py'
}
